...
import pygame, pySprites, pygame.mixer
pygame.init()
pygame.mixer.init()
...
def main():
    ...
    # ENTITIES
    background = pygame.image.load("noctua.png")
    background = pygame.transform.scale(background, (640,480))
    background = background.convert()
    screen.blit(background, (0,0))
    
    #Load Music
    music = pygame.mixer.music.load("hope.ogg")
    player_impact = pygame.mixer.Sound("slap.ogg")
    endzone_impact = pygame.mixer.Sound("explosion.ogg")
    endzone_impact.set_volume(0.5)
